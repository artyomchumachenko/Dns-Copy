...
public class ImageLoader extends MainFormController {
    ...
    private static final String pathToSearchingImage = "src/main/resources/images/searching.png";
    private static final String pathToLeftImage = "src/main/resources/images/left.png";
    private static final String pathToRightImage = "src/main/resources/images/right.png";
