...
public class MainFormController implements Initializable {
    ...
    public static void addProductToBasket(Product product) {
        ...
        for (Product currProduct : basketProducts) {
            if (product.getProductName().equals(currProduct.getProductName())) {
                isAllow = false;
                break;
            }
        }
    ...
    /**
     * Слушатель кликов на кнопки покупки товаров
     */
    @FXML
    ...
    void showAuthorizationWindow(MouseEvent event) {
        FXMLLoader loader = new FXMLLoader(
                MainApplication.class.getResource("/fxml/auth.fxml"));
        ...
        authorizationWindow.getIcons().add(new Image("/images/sign_in.png"));
    ...
    void showRegistrationWindow(MouseEvent event) {
        FXMLLoader loader = new FXMLLoader(
                MainApplication.class.getResource("/fxml/regist.fxml"));
        Stage authorizationWindow = new Stage();
        try {
            authorizationWindow.setScene(new Scene(loader.load()));
        } catch (IOException e) {
        ...
        authorizationWindow.getIcons().add(new Image("/images/icon-256x256.png"));
    ...
    void showBasket(MouseEvent event) {
        FXMLLoader loader = new FXMLLoader(
                MainApplication.class.getResource("/fxml/basket.fxml"));
        Stage authorizationWindow = new Stage();
        try {
            authorizationWindow.setScene(new Scene(loader.load()));
        } catch (IOException e) {
        ...
        authorizationWindow.getIcons().add(new Image("/images/shopping_basket.png"));
    ...
    void showProfile() {
        FXMLLoader loader = new FXMLLoader(
                MainApplication.class.getResource("/fxml/profile.fxml"));
