...
public class ProductViewController {
    ...
    public static void clickProductButtonHandler2(MouseEvent event) {
        System.out.println("Select button successfully");
        Object eventSource = event.getSource();
        if (eventSource instanceof Button clickButton) {
            clickOnProductButton2(clickButton);
        }
    }
     ...
     */
    public static void clickOnProductButton2(Button productButton) {
        Product clickProduct = clickedProduct(productButton);
    ...
    public static Product clickedProduct(Button productButton) {
